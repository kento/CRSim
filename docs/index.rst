...
| name**           |                            | **     |               |
+==================+============================+========+===============+
| **               | Synchronization L1         | int    | indispensable |
| L1ckpt_overhead**| Checkpoint time            |        |               |
+------------------+----------------------------+--------+---------------+
| **               | Asynchronous L2 checkpoint | int    | indispensable |
| L2ckkpt_latency**| time                       |        |               |
+------------------+----------------------------+--------+---------------+
| **               | Array of length 2          | List   | indispensable |
| ckptRestartTimes | containing the time        |        |               |
| **               | required for L1,L2         | [int   |               |
|                  | recovery                   | ,int]. |               |
|                  |                            |        |               |
|                  | = [L1 recovery time,L2     |        |               |
...
|                  | value                      |        |               |
+------------------+----------------------------+--------+---------------+
| **               | Frequency of Efficiency    | int    | Optional,     |
| check_interval   | change checks              |        | Default=1     |
| **               |                            |        |               |
|                  | Parameters added to the    |        |               |
|                  | specification              |        |               |
+------------------+----------------------------+--------+---------------+
